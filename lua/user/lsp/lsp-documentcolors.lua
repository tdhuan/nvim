...
-- credits: https://github.com/kabouzeid/dotfiles/blob/main/config/nvim/lua/lsp-documentcolors.lua
...
function M.buf_attach(bufnr, options)
	...
	local trigger_update_highlight, timer = require("user.lsp.defer").debounce_trailing(
		M.update_highlight,
